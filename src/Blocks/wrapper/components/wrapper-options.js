...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	...
	return (
		<Fragment>
			{!wrapperDisable &&
				<PanelBody title={__('Block Layout', 'Assignment')} initialOpen={false} className="custom-highlighted-panel">
					...
					{wrapperUseShowControl &&
						<ToggleControl
							label={wrapperUse ? __('Wrapper Enabled', 'Assignment') : __('Wrapper Disabled', 'Assignment')}
							checked={wrapperUse}
					...
					{(wrapperUse && wrapperUseSimpleShowControl) &&
						<ToggleControl
							label={wrapperUseSimple ? __('Wrapper Simple Enabled', 'Assignment') : __('Wrapper Simple Disabled', 'Assignment')}
							...
							{showWrapperSpacingBottomIn &&
								<Responsive
									label={
										<Fragment>
											<Icon icon={icons.spacingBottom} />
											{__('Spacing Bottom In', 'Assignment')}
										</Fragment>
									}
								>
										...
										<ColorPaletteCustom
											label={
												<Fragment>
													...
													{__('Background Color', 'Assignment')}
												</Fragment>
											}
